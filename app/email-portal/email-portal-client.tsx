...
export function EmailPortalClient() {
  ...
  async function scheduleCampaign() {
    setScheduleError('');
    const response = await fetch('/api/email/campaigns', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ subject, html, recipients: emails, batchSize, intervalMinutes: interval }) });
