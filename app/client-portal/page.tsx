...
export default async function ClientPortalPage(){
 ...
 try{await portalContext();}catch(error){
  ...
  return <main className="client-portal-shell flex h-screen flex-col overflow-hidden bg-brand-bg text-white"><PortalHeader solid sticky homeHref="/client-portal"/><ClientWorkspace/><PortalFooter/></main>;
}
