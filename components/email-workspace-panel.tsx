...
export function EmailWorkspacePanel(props: Props) {
  const { activePanel, onNavigate, recipientCount, batches, recipients, onRecipients, subject, onSubject, html, onHtml, batchSize, onBatchSize, interval, onInterval, scheduled, onSchedule, scheduleError, onPreview, previewOpen, onClosePreview, previewDevice, onPreviewDevice } = props;
